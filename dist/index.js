...
/* harmony import */ var _notionhq_client__WEBPACK_IMPORTED_MODULE_1__ = __nccwpck_require__(324);
...
/* harmony import */ var _tryfabric_martian__WEBPACK_IMPORTED_MODULE_4__ = __nccwpck_require__(6615);
    ...
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            for (let title in updates) {
                ...
                let next = null;
                while (true) {
                    let children = yield notion.blocks.children.list({
...
run();
function mdFiles(directory) {
    return (0,fs__WEBPACK_IMPORTED_MODULE_2__.readdirSync)(directory).flatMap(file => {
        if ((0,fs__WEBPACK_IMPORTED_MODULE_2__.lstatSync)((0,path__WEBPACK_IMPORTED_MODULE_3__.resolve)(directory, file)).isDirectory()) {
            return mdFiles((0,path__WEBPACK_IMPORTED_MODULE_3__.join)(directory, file));
        }
        else {
            if (file.endsWith('.md')) {
                return [(0,path__WEBPACK_IMPORTED_MODULE_3__.join)(directory, file)];
            }
            else {
                return [];
            }
